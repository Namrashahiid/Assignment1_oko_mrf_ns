...
What we have done in this formel up, is that we have regenerated the data, so that we can get the right values for our next steps.
...
legge inn info om dei 3 nye data settene.
