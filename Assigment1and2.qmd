...
We can see by looking this method what Y value would be when X = 0.

The formula we use for estimating the connection between regional development and regional inequality is:
...
tmp_n2 %>%
  ...
  geom_smooth(method = "lm", se = FALSE) +
   labs(x = "GDP er capita", y = "Gini nuts 2")
```
...
What wee see here for Poland is: there is 10 numbers for this country and the coefficient of determination is 0.398

What we see here for Spain is: there is there is 11 numbers and the coefficient of determination is 0.
...
What we see here from this table is data/ information of regions in Spain.
We can here see different types of region from Spain.

If we use the OLS formula here, we find that: β\^1 is approximately 0.3 and the β\^2 value is 10.3.
