...
data2010 <- data2010
lm.10 = lm(gini_n2*1000 ~ gdp_pc_n2, filter(data2010, NED == 1))
lm.11 = lm(gini_n2*1000 ~ gdp_pc_n2, filter(data2010, NED == 0))
lm.12 = lm(gini_n2*1000 ~ gdp_pc_n2 * NED , data2010)
...
Now when we take initially the p-value for only Netherlands variable, we can see at 0.026 and compare it with the 0.05 significance level, than we can say at once, that we are rejecting the null hypothesis, because 0.026\<0.05
...
```{r}
data2010 <- data2010
lm.13 = lm(gini_n2 ~ log(gdp_pc_n2), filter(data2010, NED == 1)) %>%
coeftest(vcov = hccm, save = TRUE)
lm.14 = lm(gini_n2 ~ log(I(gdp_pc_n2)^2), filter(data2010, NED == 1)) %>%
  coeftest(vcov = hccm, save = TRUE)
lm.15 = lm(gini_n2 ~ log(I(gdp_pc_n2)^3), filter(data2010, NED == 1)) %>%
  coeftest(vcov = hccm, save = TRUE)
lm.16 = lm(gini_n2 ~ gdp_pc_n2*NED, data2010) %>%
  coeftest(vcov = hccm, save = TRUE)
#Gen Table
  huxreg(
