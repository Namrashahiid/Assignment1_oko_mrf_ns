...
These lines are mostly slightly rising, which means that the countries have had a stedy rise in GDP per capita.
...
The dots indicates the regions in those five countries mentioned above.
...
If we now discuss the overall fit of our model now:

Our model does not have constant R2 values.
...
We can conclude by saying, that we don't see a connection between our variables: vehicles, education attainment and population.
...
eventuelt og: label: multi_linear_regression_model_1
