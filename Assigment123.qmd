...
What we can find here in @tbl-inference-edu is that education has its p-value on 0.79.
...
Here in @tbl-inference-demo the p-value is 0.8794, which again is not possible to reject, because there is weak evidence against the null hypothesis.
