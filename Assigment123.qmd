...
lm.1 = lm(gini_n2*100 ~ gdp_capita_n2, mlrdata)  %>%
  coeftest(vcov = hccm, save = TRUE)
lm.2 = lm(gini_n2*100 ~ gdp_capita_n2 +I(edu1/1000), mlrdata) %>%
  coeftest(vcov = hccm, save = TRUE)
lm.3 = lm(gini_n2*100 ~ gdp_capita_n2 +I(infra1/1000), mlrdata) %>%
  coeftest(vcov = hccm, save = TRUE)
lm.4 = lm(gini_n2*100 ~ gdp_capita_n2 + demo1, mlrdata) %>%
  coeftest(vcov = hccm, save = TRUE)
lm.5 = lm(gini_n2*100 ~ gdp_capita_n2 +I(infra1/1000) + I(edu1/1000) + demo1, mlrdata) %>%
  coeftest(vcov = hccm, save = TRUE)
