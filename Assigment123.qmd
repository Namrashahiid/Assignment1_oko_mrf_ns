...
When we look at our scatter plot for the gini and GDP per capita (log), we can immediately see that it is a negative trend, on the green line which represents polynomial regression\^2.
...
In comparison with line in..., we can see that these lines fit our data better.

### Give a verbal interpretation of your estimate coefficients:

We can here see that the green line starts negatively, and suddenly start getting positive after 10.3 according to the x-axis.
