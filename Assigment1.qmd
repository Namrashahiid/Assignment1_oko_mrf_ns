...
If we specify the GDP per capita for Norway line (blue line), we can see that it started pretty nice in around 2006, but then suddenly we can see it´s kind of like had decline in GDP per capita.
The reason behind this most probably because of the financial crisis, which affected the society in years 2008-2009.
Suddenly if we see GDP per capita started raising from 2009 again, and had its small fall downs in around 2015.
...
If we look at the orange line, which refers to PL214, we see that it had a
