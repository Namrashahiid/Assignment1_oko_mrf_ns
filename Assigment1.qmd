...
```{r}
tmp_gdpcapita <- gdpdata %>%
  filter(Year=="2010" & unit =='MIO_EUR' & (grepl( 'IE..', Region) |  grepl('PL..', Region) |   grepl('ES..', Region) |   grepl('SI..', Region) |   grepl('NL..', Region) |   grepl('EL..', Region) |    grepl('NO..', Region) |    grepl('AL..', Region) )) %>%
