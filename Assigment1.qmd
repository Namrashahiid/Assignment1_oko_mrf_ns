...
i tell us the abput NUTS3 regions.
j tells us NUTS 2 regions.
i and j specify region data for us.
GINI data shows us different sizes of regions etc.
...
Mean is 0, which is a little weird.
...
If we take a look at the green dots on top, we can see that it startet pretty good at start, than had its fell down in around 2008-2009.
