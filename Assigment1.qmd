...
~~The first files only contains data on NUTS3 level. In this part of the assignment we need data on NUTS2 level, therefore we need a new file. For the next submission, we can download a new data file with all data available, if needed.~~
