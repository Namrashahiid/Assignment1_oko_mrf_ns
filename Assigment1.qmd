...
We see here that we are filtering the data, and we are then getting a own file after doing so with name: tmp.
By filtering our data, our data is more presentable and more clear and visible.
