...
We now have information on GDP per capita in different regions.
...
Looking at [Table 1] and the table decriptive statistics table over, we can see substantial differences in region size as well as economic development.
The largest region ...insert region name... is almost 1000 times bigger than the smallest region ...insert region name... .
We also see a big difference in gdp per capita.
The least wealthiest region (...insert region name...) has a gdp per capita of 5652, while the wealthiest region (...insert region name...) has a gdp per capita of 55857.
...
j tells us about NUTS 2 regions.
